...
class Product
{
    public $prodId, $proName, $proTag, $proPrice, $sellUnit, $description, $inStock, $cuStock, $shopId, $catId, $variation, $virtual, $pPoints, $nPoints, $dates, $del, $shopName;
    public $db;
...
//function to gain the product id
    ...
    //function to get the shopname
    public function  getShopName($shopId)
    {
        $res1 = $this->db->getFirstRow("select shop_name from shops where shop_id = ".$shopId);
    $this->shopName = $res1['shop_name'];
    return $this;
